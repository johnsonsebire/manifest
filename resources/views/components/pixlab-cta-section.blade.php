            ...
            <div class="col-lg-5">
                <div class="text-wrapper mb-55 wow fadeInLeft">
                    <div class="section-title section-title-white section-title-left mb-35">
                        <span class="sub-title st-two">Let's work together</span>
                        <h2 class="font-45">Do you have a project in mind?</h2>
                    </div>
                    <a href="{{url('')}}" class="main-btn arrow-btn">Work with us!</a>
                </div>
            </div>
            <div class="col-lg-7">
