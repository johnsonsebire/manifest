...
<section class="counter-area counter-area-v3 light-gray-bg pt-120 pb-90 position-relative z-1">
    ...
    <div class="shape shape-two scene"><span data-depth="3"><img src="{{asset('pixlab/images/shape/shape-15.png')}}" loading="lazy" alt=""></span></div>
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="counter-item text-center mb-40 mt-lg-30 wow fadeInUp" data-wow-delay=".2s">
                    <div class="icon">
                        <img src="{{asset('pixlab/images/icon/icon-16.png')}}" loading="lazy" alt="Projects Done Icon">
                    </div>
                    <div class="text">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="counter-item text-center mb-40 wow fadeInDown" data-wow-delay=".3s">
                    <div class="icon">
                        <img src="{{asset('pixlab/images/icon/icon-17.png')}}" loading="lazy" alt="Customer Retention Icon">
                    </div>
                    <div class="text">
                        <h2 class="number"><span class="count">90</span>%</h2>
                        <p class="position">Customer Retention</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="counter-item text-center mb-40 mt-lg-3 wow fadeInUp" data-wow-delay=".4s">
                    <div class="icon">
                        <img src="{{asset('pixlab/images/icon/icon-18.png')}}" loading="lazy" alt="Years of Excellence Icon">
                    </div>
                    <div class="text">
                        <h2 class="number"><span class="count">8</span>+</h2>
                        <p class="position">Years of Excellence</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="counter-item text-center mb-40 wow fadeInDown" data-wow-delay=".5s">
                    <div class="icon">
                        <img src="{{asset('pixlab/images/icon/icon-19.png')}}" loading="lazy" alt="Creative Teams Icon">
                    </div>
                    <div class="text">
