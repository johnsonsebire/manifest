            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="service-item service-style-three mb-30 wow fadeInUp" data-wow-delay=".15s">
                        ...
                        <div class="text">
                            <h3 class="title"><a href="{{url('')}}">Creative Design</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="service-item service-style-three mb-30 wow fadeInUp" data-wow-delay=".2s">
                        ...
                        <div class="text">
                            <h3 class="title"><a href="{{url('')}}">Marketing Strategy</a></h3>
                            <p>Sed ut perspiciatis unde omnisy natus error volupt cusantium</p>
                            <a href="{{url('')}}" class="btn-link-two">Read More</a>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="service-item service-style-three mb-30 wow fadeInUp" data-wow-delay=".25s">
                        ...
                        <div class="text">
                            <h3 class="title"><a href="{{url('')}}">Design Strategy</a></h3>
                            <p>Sed ut perspiciatis unde omnisy natus error volupt cusantium</p>
                            <a href="{{url('')}}" class="btn-link-two">Read More</a>
                        </div>
                    </div>
        ...
        <div class="row masonry-row">
            ...
            <div class="col-lg-8 col-md-6 col-sm-12 portfolio-column cat-5">
                <div class="portfolio-item portfolio-style-three mb-30 wow fadeInUp">
                    <div class="img-holder">
                        <img src="{{asset('pixlab/images/portfolio/img-19.jpg')}}" alt="portfolio" data-wow-delay=".35s">
                        <div class="portfolio-hover">
                            <div class="hover-content">
                                <h3 class="title"><a href="project-details.html">Book Cover Design</a></h3>
                                <p><a href="#">Design</a>, <a href="#">Branding</a></p>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 portfolio-column cat-4 cat-1 cat-2">
                <div class="portfolio-item portfolio-style-three mb-30 wow fadeInUp" data-wow-delay=".4s">
                    <div class="img-holder">
                        <img src="{{asset('pixlab/images/portfolio/img-20.jpg')}}" alt="portfolio">
                        <div class="portfolio-hover">
                            <div class="hover-content">
                                <h3 class="title"><a href="project-details.html">Book Cover Design</a></h3>
                                <p><a href="#">Design</a>, <a href="#">Branding</a></p>
...
<section class="counter-area counter-area-v3 light-gray-bg pt-120 pb-90 position-relative z-1">
    ...
    <div class="shape shape-two scene"><span data-depth="3"><img src="{{asset('pixlab/images/shape/shape-15.png')}}" alt=""></span></div>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="counter-item text-center mb-40 mt-lg-30 wow fadeInUp" data-wow-delay=".2s">
                    <div class="icon">
                        <img src="{{asset('pixlab/images/icon/icon-16.png')}}" alt="">
                    </div>
                    <div class="text">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="counter-item text-center mb-40 wow fadeInDown" data-wow-delay=".3s">
                    <div class="icon">
                        <img src="{{asset('pixlab/images/icon/icon-17.png')}}" alt="">
                    </div>
                    <div class="text">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="counter-item text-center mb-40 mt-lg-3 wow fadeInUp" data-wow-delay=".4s">
                    <div class="icon">
                        <img src="{{asset('pixlab/images/icon/icon-18.png')}}" alt="">
                    </div>
                    <div class="text">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="counter-item text-center mb-40 wow fadeInDown" data-wow-delay=".5s">
                    <div class="icon">
                        <img src="{{asset('pixlab/images/icon/icon-19.png')}}" alt="">
                    </div>
                    <div class="text">
        ...
        <div class="row justify-content-center">
            {{-- <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="blog-post-item mb-40 wow fadeInUp" data-wow-delay=".2s">
                    <div class="post-thumbnail">
                        <img src="{{asset('pixlab/images/blog/img-1.jpg')}}" alt="post image">
                    </div>
            ...
            {{-- <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="blog-post-item mb-40 wow fadeInUp" data-wow-delay=".3s">
                    <div class="post-thumbnail">
                        <img src="{{asset('pixlab/images/blog/img-2.jpg')}}" alt="post image">
                    </div>
                    <div class="entry-content">
                        <a href="blog-details.html" class="icon-btn"><i class="fas fa-arrow-right"></i></a>
                        <h4 class="title"><a href="blog-details.html">Guide To Newly Suppored Modern CSS Pseudo</a></h4>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="blog-post-item mb-40 wow fadeInUp" data-wow-delay=".4s">
                    <div class="post-thumbnail">
                        <img src="{{asset('pixlab/images/blog/div_or_hire_blog_image.png')}}" alt="post image">
                    </div>
                    <div class="entry-content">
                        <a href="{{url('https://medium.com/@johnsonsebire/do-it-yourself-or-hire-a-professional-developer-d1189dc390a7')}}" class="icon-btn"><i class="fas fa-arrow-right"></i></a>
                        <h4 class="title"><a href="{{url('https://medium.com/@johnsonsebire/do-it-yourself-or-hire-a-professional-developer-d1189dc390a7')}}">Do It Yourself or Hire a Professional Developer?</a></h4>
                        <p>When you want to develop a website, you will have two main options to consider... </p>
                        <div class="post-meta">
                            <ul>
                                <li><span><i class="far fa-calendar-alt"></i><a href="{{url('https://medium.com/@johnsonsebire/do-it-yourself-or-hire-a-professional-developer-d1189dc390a7')}}">Jul 20, 2021</a></span></li>
                                <li><span><i class="far fa-comments"></i><a href="{{url('https://medium.com/@johnsonsebire/do-it-yourself-or-hire-a-professional-developer-d1189dc390a7')}}">Responses (1)</a></span></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<section class="cta-area cta-area-v3 pt-55 position-relative z-1">
    <div class="shape shape-one"><span><img src="{{asset('pixlab/images/shape/shape-18.png')}}" alt=""></span></div>
    <div class="shape shape-two"><span><img src="{{asset('pixlab/images/shape/shape-19.png')}}" alt=""></span></div>
    <div class="shape shape-three"><span><img src="{{asset('pixlab/images/shape/shape-20.png')}}" alt=""></span></div>
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-5">
